...
//using CarGlassDesafioTecnico.Application.Usecases.Usuarios.Create;
//using CarGlassDesafioTecnico.Application.Usecases.Usuarios.Delete;
//using CarGlassDesafioTecnico.Application.Usecases.Usuarios.Read;
//using CarGlassDesafioTecnico.Application.Usecases.Usuarios.Update;
...
//namespace CarGlassDesafioTecnico.Test.Unit.Presentation.Controllers
//{
//    [TestClass]
...
//            Assert.AreEqual(dto.Email, ((CarGlassDesafioTecnico.Domain.Entities.Usuario)((Microsoft.AspNetCore.Mvc.ObjectResult)result.Result).Value).Email);
...
//            Assert.AreEqual(usuarioDto.Id, ((CarGlassDesafioTecnico.Dto.Usuarios.UsuarioDto)((Microsoft.AspNetCore.Mvc.ObjectResult)result.Result).Value).Id);
...
//            Assert.IsTrue(((CarGlassDesafioTecnico.Domain.Data.PagedResponse<CarGlassDesafioTecnico.Dto.Usuarios.UsuarioDto>)((Microsoft.AspNetCore.Mvc.ObjectResult)result.Result).Value).Success);

//            Assert.AreEqual(dto.Count, ((CarGlassDesafioTecnico.Domain.Data.PagedResponse<CarGlassDesafioTecnico.Dto.Usuarios.UsuarioDto>)((Microsoft.AspNetCore.Mvc.ObjectResult)result.Result).Value).TotalCount);
...
//            Assert.AreEqual(dto.Nome, ((CarGlassDesafioTecnico.Domain.Entities.Usuario)((Microsoft.AspNetCore.Mvc.ObjectResult)result.Result).Value).Nome);
